...
# Backup
shutil.copy("ptz_config.yaml", "ptz_config.yaml.bak_4quadrant")
shutil.copy("ptz_stream.py", "ptz_stream.py.bak_4quadrant")

# Prepare novis version
with open("ptz_stream.py", "r") as f:
    code = f.read()
...
base_cfg = {
    ...
    "focal_length_1x": 6,
    "camera_rig_translate_xyz": [84.2, 10.87, 6.53],
...
configs = [
    {
        "name": "1_old_raytraced",
        "scene_path": "/home/uniubi/xuanyuan/camera05/camera03/scene_single_with_ptz.usda",
        "renderer": "PathTracing",
        "vis_enabled": False
    },
    {
        "name": "2_old_hydrastorm",
        "scene_path": "/home/uniubi/xuanyuan/camera05/camera03/scene_single_with_ptz.usda",
        "renderer": "PathTracing",
        "vis_enabled": False
    },
    {
        "name": "3_new_raytraced_novis",
        "scene_path": "/home/uniubi/xuanyuan/camera05/camera03/scene_4diaolan_ptz.usda",
        "renderer": "PathTracing",
        "vis_enabled": False
    },
    {
        "name": "4_new_raytraced_vis",
        "scene_path": "/home/uniubi/xuanyuan/camera05/camera03/scene_4diaolan_ptz.usda",
        "renderer": "PathTracing",
        "vis_enabled": True
    }
...
try:
    ...
    shutil.copy("ptz_stream.py.bak_4quadrant", "ptz_stream.py")
    with open("_quadrant_results.json", "w") as f:
