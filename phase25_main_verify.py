...
def main():
    ...
    # 恢复 force_active_diaolan_path / force_workers_count / force_gondola_height
    # Wait, the instruction says:
    # "D. 在主链路最小验证通过后，再恢复：force_active_diaolan_path / force_workers_count / force_gondola_height"
    # So for B, we should NOT restore them yet!
